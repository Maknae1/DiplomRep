...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasOne(d => d.Pbo).WithMany(p => p.Employees)
        ...
        modelBuilder.Entity<FeedBack>(entity =>
        {
            ...
            entity.HasOne(d => d.Pbo).WithMany(p => p.FeedBacks)
                .HasForeignKey(d => d.PboId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_pboid");
        });
        ...
        modelBuilder.Entity<Questionaire>(entity =>
        {
            ...
            entity.HasOne(d => d.Pbo).WithMany(p => p.Questionaires)
                .HasForeignKey(d => d.PboId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_pboid");
        });
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "fki_fk_roleid");
